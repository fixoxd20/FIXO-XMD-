...
if (!fs.existsSync(__dirname + "/sessions/creds.json")) {
  ...
  const sessdata = config.SESSION_ID.replace('FIXO-XMD~', '');
...
const robin = makeWASocket({
  ...
  robin.ev.on("connection.update", (update) => {
    ...
    if (connection === "close") {
      ...
      console.log("FIXO XMD HAS SUCCESFULLY BEEN CONNECTED TO YOUR WHATSAPP ✅");
...
//=====================================================================================================================================
  ...
  app.get("/", (req, res) => {
    res.send("FIXO XMD LAUNCHED AND READY TO USE ✅");
  });
