...
module.exports = {
  ...
  SESSION_ID: process.env.SESSION_ID || "FIXO-XMD~4391AbRJ#XxCP8sq-ctRKViBYGD0bxz5vPAI23SuYTn7fEKVEL_o", // Add your session ID here
  ...
  // Bot Settings
  BOT_NAME: process.env.BOT_NAME || "𝙵𝙸𝚇𝙾 𝚇𝙼𝙳", // Add your bot's name here
  ...
  STATUS_MESSAGE: process.env.STATUS_MESSAGE || "🚀 𝙋𝙤𝙬𝙚𝙧𝙚𝙙 𝙗𝙮 𝗙𝗜𝗫𝗢-𝗫𝗠𝗗", // Customize the bot's status message
  ...
  // Alive Message & Image
  ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/et3unf.png", // Add your alive image URL here
  ALIVE_MSG: process.env.ALIVE_MSG || "Hello , I am alive now!!", // Customize the alive message here

  // Sticker Settings
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || "FIXO XMD", // Set your sticker pack name here
  STICKER_AUTHOR: process.env.STICKER_AUTHOR || "FIXO XD", // Set your sticker author name here
