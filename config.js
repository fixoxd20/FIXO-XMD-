...
module.exports = {
  ...
  SESSION_ID: process.env.SESSION_ID || "FIXO-XMD~82kF3RhC#mnbJdTJJLzDoB9fnpIQ2-lYoaUtaE31PRiD7MUsKLFo", // Add your session ID here
  ...
  // Bot Settings
  BOT_NAME: process.env.BOT_NAME || "ꜰɪxᴏ xᴍᴅ", // Add your bot's name here
